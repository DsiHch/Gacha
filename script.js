...
const gemsDisplay =
    document.getElementById("gemsDisplay");

const logoutButton =
    document.getElementById("logoutButton");

const bannersButton =
    document.getElementById("bannersButton");

const inventoryButton =
    document.getElementById("inventoryButton");

const catalogueButton =
    document.getElementById("catalogueButton");
